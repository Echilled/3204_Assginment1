...
### Heartbeat
curl -XPUT -H "Content-Type: application/json" 'http://elk:9200/_template/heartbeat?pretty' -d@/etc/heartbeat/heartbeat.template.json
/etc/init.d/heartbeat-elastic start
